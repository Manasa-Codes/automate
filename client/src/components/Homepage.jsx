      ...
      <nav className="navbar">
        ...
        <ul className="navbar-menu">
          ...
          <li className="navbar-item">
            ...
            <button 
              className="navbar-button" 
              onClick={() => navigate('/login')} // Use useNavigate hook for redirection
            >
              Login
            </button>
          </li>
          <li className="navbar-item">
            {/* Navigate to Signup page when the button is clicked */}
            <button 
              className="navbar-button" 
              onClick={() => navigate('/signup')} // Use useNavigate hook for redirection
            >
              Signup
            </button>
          </li>
